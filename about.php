...
?>
        ...
        <div class="main-container">
          <div class="row">
            <div class="col-sm-6" id="top-photo">
              <img src="img/v-Pierce.jpg">
              ...
              tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo  consequat. Duis aute irure dolor in reprehenderit in voluptate 
              cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non velit esseproident, sunt in culpa qui officia deserunt mollit anim id est laborum.
             </p>
            </div>
          </div>
          <div class="col-sm-3" id="top-box">
              <img id="box-photo" src="img/curlygrey.jpg">
